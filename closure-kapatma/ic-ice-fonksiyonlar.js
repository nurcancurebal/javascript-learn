...
let kullanici = new Kullanici("Erdinç");

console.log(kullanici); // Kullanici { Kullanici: f }

// metod dışarıda bulunan "isim" değişkenine erişebilir.
...
// Muhetemelen, aklınızda dış değişkenlerin nasıl çalıştığı açıklığa kavuştu.