/* -> jeneratörler
Normal işlevler yalnızca bir, tek bir değer (veya hiçbir şey) döndürür.
...
Bir üreteç oluşturmak için özel bir sözdizimi yapısına ihtiyacımız var: function*"jeneratör işlevi" olarak adlandırılan.
...
// "jeneratör işlevi", "jeneratör nesnesi" yaratır
let generator1 = generateSequence();

/* Nesne generatorbir "donmuş işlev çağrısı" olarak algılanabilir:
...
. done: falsekod henüz tamamlanmadıysa, aksi halde true.
...
// Ve üçüncü kez çağırırsak, yürütme returnişlevi bitiren ifadeye ulaşır:

let three = generator.next();

console.log(JSON.stringify(three)); // {"value":3,"done":true}

/* Şimdi jeneratör tamamlandı. Nihai sonuç olarak görmeli done:trueve işleme koymalıyız.value:3
...
Şimdiye kadar anlaşılması gereken en önemli şey, üreteç işlevlerinin normal işlevin aksine kodu çalıştırmamasıdır. “Jeneratör fabrikaları” olarak hizmet veriyorlar. Çalıştırmak function*bir jeneratör döndürür ve ardından ondan değerler isteriz. */


/* -> function* f(…)veya function *f(…)?
Bu küçük bir dini soru, her iki sözdizimi de doğru.

Ancak genellikle ilk sözdizimi tercih edilir, çünkü yıldız *bunun bir üretici işlevi olduğunu belirtir, adı değil türü tanımlar, bu nedenle functionanahtar kelimeye bağlı kalmalıdır. */